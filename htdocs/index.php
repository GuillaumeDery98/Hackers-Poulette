            ...
            <div class="form-row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="sujet" id="sujet" class="form-control">
                        ...
                        <option value="homme">Demande</option>
                        <option value="femme">S.A.V</option>
                    </select>
                </div>
            </div>
            <div class="form-row">
                ...
                <textarea type="textarea" name="message" id="message" class="form-control <?php if ((empty($_POST["prenom"])) && isset($_GET["rendu"])) {
                                                                                                echo "rouge";
